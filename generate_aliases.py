...
def main():
    ...
    res = [
        ...
        ('sts', 'statefulset', ['g', 'd', 'rm', 'e'], ['sys']),
        ('cj', 'cronjob', ['g', 'd', 'rm', 'e'], ['sys']),
        ('j', 'job', ['g', 'd', 'rm', 'e'], ['sys']),
        ('pvc', 'persistentvolumeclaim', ['g', 'd', 'rm', 'e'], ['sys']),
        ('pv', 'persistentvolume', ['g', 'd', 'rm', 'e'], ['sys']),
        ('ds', 'daemonset', ['g', 'd', 'rm', 'e'], ['sys']),
        ('crd', 'customresourcedefinition', ['g', 'd', 'rm', 'e'], None),
        ('pdb', 'poddisruptionbudgets', ['g', 'd', 'rm', 'e'], ['sys']),
        ('psp', 'podsecuritypolicies', ['g', 'd', 'rm', 'e'], None),
        ('ep', 'endpoint', ['g', 'd', 'rm'], ['sys']),
        ('sc', 'storageclasses', ['g', 'd', 'rm', 'e'], None),
        ('sa', 'serviceaccount', ['g', 'd', 'rm', 'e'], ['sys']),
        ('r', 'role', ['g', 'd', 'rm', 'e'], ['sys']),
        ('rb', 'rolebinding', ['g', 'd', 'rm', 'e'], ['sys']),
        ('cr', 'clusterrole', ['g', 'd', 'rm', 'e'], None),
        ('crb', 'clusterrolebinding', ['g', 'd', 'rm', 'e'], None),
        ]
